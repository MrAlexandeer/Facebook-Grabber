...
try:
	...
	print W + ' '
	print ('Valex ( By MrAlexander )').center(44)
	print ' '
...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     MrAlexander ( Adil Hamidi )
    Name       Valex 'Open Source Information Facebook'
    CodeName   Valex
    version    full version
    Date       16/05/2018 09:35:12
    Team       ValexFrags
    Email      alexander.richtar@hotmail.com
    Instagram  MrAlexander_tv
